...
export const DEVASSIST_SERVICE = {
	FEEDBACK_FORM: {
		WEBVIEW_TITLE: 'DEVASSIST_SERVICE_FEEDBACK_FORM_DOCUMENT_TITLE',
		TITLE: 'DEVASSIST_SERVICE_FEEDBACK_FORM_TITLE',
		SUBTITLE: 'DEVASSIST_SERVICE_FEEDBACK_FORM_SUBTITLE',
		TEXTAREA_SUBTITLE: 'DEVASSIST_SERVICE_FEEDBACK_FORM_TEXTAREA_SUBTITLE',
		TEXTAREA_HINT: 'DEVASSIST_SERVICE_FEEDBACK_FORM_TEXTAREA_HINT',
		CHECKBOX_LIST_SUBTITLE: 'DEVASSIST_SERVICE_FEEDBACK_FORM_CHECKBOX_LIST_SUBTITLE',
		CHECKBOX_LIST_OPTIONS: {
			OPTION_1: 'DEVASSIST_SERVICE_FEEDBACK_FORM_CHECKBOX_LIST_OPTIONS_OPTION_1',
			OPTION_2: 'DEVASSIST_SERVICE_FEEDBACK_FORM_CHECKBOX_LIST_OPTIONS_OPTION_2',
			OPTION_3: 'DEVASSIST_SERVICE_FEEDBACK_FORM_CHECKBOX_LIST_OPTIONS_OPTION_3',
			OPTION_4: 'DEVASSIST_SERVICE_FEEDBACK_FORM_CHECKBOX_LIST_OPTIONS_OPTION_4',
			OPTION_5: 'DEVASSIST_SERVICE_FEEDBACK_FORM_CHECKBOX_LIST_OPTIONS_OPTION_5',
		},
		RATING_SUBTITLE: 'DEVASSIST_SERVICE_FEEDBACK_FORM_RATING_SUBTITLE',
		BUTTON: {
			SUBMIT: 'DEVASSIST_SERVICE_FEEDBACK_FORM_BUTTON_SUBMIT',
			CANCEL: 'DEVASSIST_SERVICE_FEEDBACK_FORM_BUTTON_CANCEL'
		}
	},
	IS_DISABLED: {
